...
if __name__ == '__main__':
    ...
    # # 创建用户
    # data = {'user_id':200,'password':200}
    # url = 'http://127.0.0.1:5000/auth/register'
    # r = requests.post(url=url,headers = headers,data=json.dumps(data))

    # # 添加商店
    # data = {'store_id':200,'user_id':200}
    # url = 'http://127.0.0.1:5000/seller/create_store'
    # r = requests.post(url=url,headers = headers,data=json.dumps(data))


    # ###为商店添加新的书本
    # data = {'store_id': 200, 'user_id': 200, 'book_info':{'id':'1','title':'c++','price':10},'stock_level':10}
    ...
    # terminal = '12'
    # #
    # # res = jwt_encode(user_id,terminal)
    # # res2 = jwt_decode(res,user_id)
    # # print(type(res2))


    # 把停用词表变成一个列表
    # path = './fe/data/stop_words.txt'
