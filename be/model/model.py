...
class Config(object):  # 创建配置，用类
    ...
    JOBS = [
        # {  # 第1个任务，每隔15min执行一次
        #     'id': 'start_deliver',
        #     'func': 'be.model.logistics:fc.start_deliver',  # 方法名
        #     'args': (),  # 入参
        #     'trigger': 'interval',  # interval表示循环任务
        #     'seconds': Time['START'],  # 15min
        # },
        # {  # 第2个任务，每隔15min执行一次
        #     'id': 'confirm_receipt',
        #     'func': 'be.model.logistics:fc.confirm_receipt',  # 方法名
        #     'args': (),  # 入参
        #     'trigger': 'interval',  # interval表示循环任务
        #     'seconds': Time['CONFIRM'],  # 15min
        # }
    ]